...
public class ManageNewsPage {
	...
	// New User
	@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/news/add']")WebElement newIcon;
	@FindBy(id="news")WebElement newNewsField;
	...
	//Reset
	@FindBy(xpath="//a[@class='btn btn-rounded btn-warning']")WebElement resetIcon;
	...
	{
		newNewsField.sendKeys("Tomorrow will be a holiday");
	}
